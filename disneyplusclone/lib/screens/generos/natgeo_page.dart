                ...
                child: Column(
                  children: [
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          Padding(
                            ...
                            child: Image.asset('assets/posteres/natgeo/1.jpg',fit: BoxFit.cover),
                          ),
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 6),
                            child: Image.asset('assets/posteres/natgeo/4.jpg',fit: BoxFit.cover),
                          ),
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 6),
                            child: Image.asset('assets/posteres/natgeo/3.jpg',fit: BoxFit.cover),
                          ),
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 6),
                            child: Image.asset('assets/posteres/natgeo/2.jpg',fit: BoxFit.cover),
                          ),
                          Padding(
                            padding: EdgeInsets.symmetric(horizontal: 6),
                            child: Image.asset('assets/posteres/natgeo/1.jpg',fit: BoxFit.cover),
                    ...
                    Container(
                      margin: EdgeInsets.only(left: 10, top: 10),
                      alignment: Alignment.centerLeft,
                      child: Text("Filmes",style: TextStyle(color: Colors.white.withOpacity(0.8),fontWeight: FontWeight.bold)),
                    ),
                    Container(
                      margin: EdgeInsets.symmetric(vertical: 10),
                      height: 160,
